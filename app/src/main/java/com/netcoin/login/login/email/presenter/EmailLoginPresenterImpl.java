...
import com.netcoin.login.login.email.interactor.EmailLoginInteractor;
import com.netcoin.login.login.email.interactor.EmailLoginInteractorImpl;
import com.netcoin.login.login.email.view.EmailLoginFragmentView;
import com.netcoin.login.login.email.view.LoginActivityFragment;
